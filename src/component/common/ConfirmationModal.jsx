...
function ConfirmationModal({modalData}) {
  return (
    <div className='fixed inset-0 z-[1000] !mt-0 grid place-items-center overflow-y-auto overflow-x-hidden bg-opacity-10 backdrop-blur-sm '>
        <div className='w-11/12 max-w-[350px] rounded-lg border border-[#6E727F] bg-[#161D29] p-6'> 
            <p className='mt-3 mb-5 leading-6 text-[#F1F2FF] '>
              {modalData.text1}
            </p>
